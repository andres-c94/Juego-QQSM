...
<span id="ponente1" style="font-size: 140%; font-weight: bold; top: 0%" >Llamando a: Cristian Parra</span>
</div>

<!--**************** M O D A L I D A D   6  P R E G U N T A S ***************************** -->
...
<div class="logo2">
  ...
  <div id="ventana2" class="ventana2">
    ...
    <div>
      <span style="font-size: 230%; font-weight: bold;" class="amarillo">Ayuda del publico</span>
    </div>
    <div>
