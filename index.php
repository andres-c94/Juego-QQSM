...
<body>
  <div class="menu">
    <button class="btnx" id="ayuda" data-toggle="tooltip" data-placement="bottom" title="Ingrese el usuario y contraseña para iniciar el juego.">Ayuda <i class="fas fa-question-circle"></i></button>
  </div>
  <div class="logo2">
